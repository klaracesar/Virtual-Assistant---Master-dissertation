...
if nombre_echanges >= 4:
    ...
    base_url = "https://docs.google.com/forms/d/e/1FAIpQLSdBEjtGC6-Vumz0DCYcn5sY429bFTLvAkQ1TWXt3o-Htg4OAw/viewform?usp=pp_url&entry.635472650=valeur+groupe"
    
    url_dynamique = f"{base_url}&entry.635472650={current_group}"
